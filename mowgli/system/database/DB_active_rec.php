...
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 * -----------------------------------------------------------------------------------------
	 * -----------------------------------------------------------------------------------------
	 * -------------------- WebMowgli Custom Code START----------------------------------------------
	 * -----------------------------------------------------------------------------------------
	 * -----------------------------------------------------------------------------------------
	 */

	/**
	 * Added variable $ar_ignore to enable 'INSERT IGNORE' functionality in mysql
	 * @author Lloyd Saldanha
	 */
	var $ar_ignore = FALSE;

	/**
	 * To enable 'INSERT IGNORE' functionality in mysql
	 * @author Lloyd Saldanha
	 */
...
//	/**
//	 * Set Global protect identifiers to enable OR disable escaping sql queries
//	 * @author Lloyd Saldanha
//	 */
//	function set_escape( $escape = null ){
//
//		if( is_bool($escape) ){
//
...
//	}
	public function limit($value, $offset = '') {
		...
		///**
		// * Allow default value of limit to be null
		// * if limit = null, ==> then Do Not add limit to SQL
		//
		// Original Code
		// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// $this->ar_limit = (int) $value;
	...
	protected function _reset_write() {
		 ...
		 */
		/**
		 * Added variable $ar_ignore to enable
		 * 'INSERT IGNORE' functionality in mysql
		 * @author Lloyd Saldanha
		 */
		$ar_reset_items['ar_ignore'] = FALSE;
