...
//        private $_no_cache;
        ...
        private $_allow_caching;        // if = false will NOT write OR read Cache files
...
//                $this->_no_cache = false;
                $this->_allow_caching = true;
...
//        public function no_cache( $noCache ){
//                $this->_no_cache = (bool)$noCache;
//                
//        }
        
        public function allow_caching( $allow = true ){
                $this->_allow_caching = (bool)$allow;
        ...
        private function _call_BACKUP($property, $method, $arguments = array(), $expires = NULL) {
        ...
        private function _call($property, $method, $arguments = array(), $expires = NULL) {
                ...
                // check if cache data should be used/ignored
                if ($this->_allow_caching === true) {

                        // perform normal caching operations ( read from cache files or regenerate )
                        ...
                        // DO NOT read from cache, Simply generate content flike normal
        ...
        function get($filename = NULL, $use_expires = true) {
                ...
                // Override normal behaviour ( DO NOT retreive cached copy ) if allow_caching = false
                if( $this->_allow_caching === false ){
                        return false;
                }
