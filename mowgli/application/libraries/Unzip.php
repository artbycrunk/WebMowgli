...
class Unzip {
	...
	function __construct()
	{
        ...
        /**
         * unzips a zip file, store in destination directory, if dest = null --> store in source directory
         * @param string $source path of zip file to extract
         * @param string $dest path of destination directory / null
         * @param array $allowedFileTypes string array of list of allowed filetypes. if null --> all files
         * @param bool $preservePath if original directory structure should be maintained in destination directory
         *
         * @return array|false returns an array containing full paths of all files unzipped. if successfull, else returns false
         */
        public function unzip_file( $source, $dest = null, $allowedFiletypes = null, $preservePath = TRUE) {

                $this->allow($allowedFiletypes);
                $fileLocations = $this->extract($source, $dest, $preservePath);
                $this->close();
