...
var photos = [
{
	"image" : "img/bg/spaces.jpg",
	"color" : "#000000"
},
{
	"image" : "img/bg/grunge.jpg",
	"color" : "#ffffff"
},
{
	"image" : "img/bg/blue.jpg",
	"color" : "#ffffff"
},
{
	"image" : "img/bg/twilight.jpg",
	"color" : "#000000"
},
{
	"image" : "img/bg/rainbow.jpg",
	"color" : "#ffffff"
}
];
...
jQuery(document).ready(function($) {
	...
	$("#control").toggle(function(){
		...
		$(this).css({
			"background-image" : "url(img/slider/btn_pause.png)"
		});
	...
	var stopAnimation = function() {
		...
		$("#control").css({
			"background-image" : "url(img/slider/btn_play.png)"
		});
